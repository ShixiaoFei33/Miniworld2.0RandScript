...
local function My_info(eventobjid)
    local found = false
    for k, v in ipairs(Data) do
        if v.k == tostring(eventobjid) then       -- 改v.k
            found = true
...
local function Render(eventobjid)
